...
/*
Método: cálculo de la bound. Al tratar un problema de maximización (maximizar el valor de los objetos), necesitamos 
una bound superior del valor de la mejor solución alcanzable. 
Bound: cálculo voraz. Se ordenan los objetos en orden decreciente de valor por unidad de peso, y se seleccionan sin
...
//         bound := bound + ((input.maxWeight - pesoAct) / input.items[i].weight) * input.items[i].value;
//     }
// }
...
/* 
Método: punto de partida del algoritmo BT. El método busca explorar todas las posibles combinaciones de objetos, 
