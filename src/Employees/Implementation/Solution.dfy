...
class Solution {
  ...
  */
  ...
  // Relacionar totalTime de las tareas que están a true con el totaltime calculado de this.employeesAssign hasta this.k
  // demo que input.times[i, t] ha sido sumado
